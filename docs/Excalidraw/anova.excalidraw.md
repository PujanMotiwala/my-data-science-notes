...
OR
p <= 0.05, Accept H0
Result: Sample mean is statistically insignificant ^cPst4Yxc

But what's driving 
that difference? ^mFAbkNHu

when test is significant 
for all three means ^4ZFBoglE

Tukey multiple comparisons of means 95% family-wise 
confidence level  ^q35RviN2

| continent | mean-diff | lower_ci l upper_ci | [[p-values]] |
